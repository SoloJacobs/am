...
// Package cluster uses `hashicorp/memberlist` to maintain a list of
// alertmanagers, which then exchange
// * a notification log,
// * periodically check the health of the other members,
// * can forward silences.
package cluster
